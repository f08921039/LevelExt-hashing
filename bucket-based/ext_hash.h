...
#define EH_SEGMENT_SIZE	512
#define EH_SEGMENT_SIZE_BIT	9


#define EH_BUCKET_INDEX_BIT	1
...
#define EH_SEG_LOCKED_SHIFT	((VALID_POINTER_BITS - 1) + 1)
#define EH_SEG_SPLITING_SHIFT	((VALID_POINTER_BITS - 1) + 2)
#define EH_SEG_MIGRATE_SHIFT	((VALID_POINTER_BITS - 1) + 3)

#define eh_seg_depth(ent1)	((ent1) >> (POINTER_BITS - EH_DEPTH_BITS))
...
#define extract_eh_seg_addr(ent)	((ent) & VALID_POINTER_MASK)
...
#define make_eh_dir_ent1(seg, depth)	(((uintptr_t)(seg)) | (((uintptr_t)(depth)) << (POINTER_BITS - EH_DEPTH_BITS)))
...
#define EH_ENTRY_MOVE1_SHIFT	1
#define EH_ENTRY_MOVE2_SHIFT	2
...
#define eh_entry_valid(entry)	(eh_entry_kv_addr(entry))
#define eh_entry_split(entry)	(!((entry) & (1UL << EH_ENTRY_SPLIT_SHIFT)))
#define eh_entry_move(entry, id)	((entry) & (1UL << (EH_ENTRY_MOVE1_SHIFT + (id))))
...
#define set_eh_entry_move(entry, id)	((entry) | (1UL << (EH_ENTRY_MOVE1_SHIFT + (id))))
