...
#include "eh_context.h"
	...
	#define EH_SEGMENT_SIZE_BITS	14
#endif
...
#define EH_TWO_SEGMENT_SIZE_BIT	(EH_SEGMENT_SIZE_BITS + 1)

#define EH_FOUR_SEGMENT_SIZE	MUL_2(EH_SEGMENT_SIZE, 2)
#define EH_FOUR_SEGMENT_SIZE_BIT	(EH_SEGMENT_SIZE_BITS + 2)
...
#define EH_NEXT_SEG_BIT_START	0
...
#define EH_LEFT_TWO_SEG_BIT	(VALID_POINTER_BITS + 1)
#define EH_BUCKET_SPLIT_BIT	(VALID_POINTER_BITS + 2)
#define EH_BUCKET_MIGRATING_BIT	(VALID_POINTER_BITS + 3)


#define eh_seg_low(header)	((header) & SHIFT(EH_LOW_SEG_BIT))
#define eh_seg_splited(header)	((header) & SHIFT(EH_BUCKET_SPLIT_BIT))
#define eh_seg_migrating(header)	((header) & SHIFT(EH_BUCKET_MIGRATING_BIT))
#define eh_seg_migrating_or_splited(header)	((header) &	\
				(SHIFT(EH_BUCKET_SPLIT_BIT) | SHIFT(EH_BUCKET_MIGRATING_BIT)))
...
#define set_eh_seg_migrating(header)	((header) | SHIFT(EH_BUCKET_MIGRATING_BIT))
...
#define clear_eh_seg_migrating_and_splited(header)	((header) &	\
				~(SHIFT(EH_BUCKET_SPLIT_BIT) | SHIFT(EH_BUCKET_MIGRATING_BIT)))
